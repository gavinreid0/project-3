export const ProductData = [
  {
    name: "Solid Gold OVO x Air Jordan",
    imageUrl: "https://www.footshop.cz/blog/wp-content/uploads/2020/01/12.jpg",
    description: "24 carat solid gold sneakers, made by Jordan and OVO.",
    price: 2000000,
    countInStock: 1,
  },
  {
    name: "Air Jordan Silver Shoes",
    imageUrl:
  ...
  {
    name: "Macklemore x Air Jordan 6 Cactus",
    imageUrl:
  ...
  {
    name: "Nike x MSCHF Air Max 97 Jesus Shoes –  Walk On Water",
    imageUrl:
    ...
    description: "Contains 60ml of holy water from the Jordan river.",
    price: 4000,
    countInStock: 1000,
  },
];
